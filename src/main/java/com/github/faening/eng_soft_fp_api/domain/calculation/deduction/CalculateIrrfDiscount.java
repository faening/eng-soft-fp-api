...
/*
 * Requisito: [RD015] Calcular Desconto IRRF
 *
 * Descrição:
 * Esta classe é responsável por calcular o desconto de IRRF de um funcionário em um determinado mês.
 *
 *
 * Funcionamento:
 * Para realizar os cálculos, esta classe observa as propriedades `employee.salary` e `tax_or_value` com o `type`: `IRRF`.
 * Observe que a base de cálculo do IRRF possui alguma deduções, como dependentes, pensão alimentícia, entre outros.
 *
 * Exemplos:
 * ...
 */
