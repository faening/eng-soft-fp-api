...
/*
 * Requisito: [RD019] Calcular Desconto Judicial
 *
 * Descrição:
 * Esta classe é responsável por calcular o descontos judiciais de um funcionário em um determinado mês.
 *
 *
 * Funcionamento:
 * Para realizar os cálculos, esta classe observa as tabelas `LegalCharge` e `Legal Charge Installments `.
 * Observe que se houver recorrencia (isRecurring) a cobrança deve ser feita mensalmente.
 * Observe que se houver percentual, deve-se aplica-lo sobre o salario bruto no funcinario `employee.salary`.
 *
 *
 * Exemplos:
 * ...
...
@Component
public class CalculateLegalChargeDiscount implements PayrollCalculation {
    /*
