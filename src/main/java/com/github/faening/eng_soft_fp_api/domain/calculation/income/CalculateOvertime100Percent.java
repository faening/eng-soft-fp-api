 ...
 *
 * Descrição:
 * Esta classe é responsável por calcular as horas extras com acréscimo de 100% recebidas por um funcionário em um determinado mês.
 * ...
 *
 * Funcionamento:
 * O cálculo das horas extras com acréscimo de 50%, é feito com base nas horas registradas na tabela `hours_worked_sheet.overtime100` para o
...
public class CalculateOvertime100Percent implements PayrollCalculation {
    @Override
