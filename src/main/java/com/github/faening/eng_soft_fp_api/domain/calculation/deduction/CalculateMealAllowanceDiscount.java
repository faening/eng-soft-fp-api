...
/*
 * Requisito: [RD017] Calcular Desconto Vale Alimentação
 *
 * Descrição:
 * Esta classe é responsável por calcular o desconto de vale alimentação de um funcionário em um determinado mês.
 *
 *
 * Funcionamento:
...
@Component
public class CalculateMealAllowanceDiscount implements PayrollCalculation {
    /*
