 ...
 *
 * Descrição:
 * Esta classe é responsável por calcular o desconto de Contribuição Sindical de um funcionário em um determinado mês.
 *
 *
 * Funcionamento:
 * Para realizar os cálculos, esta classe observa as propriedades `union_contribution.opted_out`. Se o funcionário tiver optado por não
 * contribuir com o sindicato, o desconto não será aplicado. Caso contrário, o desconto será aplicado sobre o salário base do funcionário.
 *
 * Exemplos:
 * ...
 */
